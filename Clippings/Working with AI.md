...
source: "https://developer.adobe.com/commerce/extensibility/app-management/working-with-ai"
author:
published:
created: 2026-09-15
...
tags:
  - "clippings"
---
Adobe publishes Commerce development MCPs and skills for building and migrating App Management apps. These skills follow the open [agentskills.io](https://agentskills.io/ "agentskills.io") standard, so they work with Claude Code, Cursor, VS Code Copilot, Gemini CLI, and other supported coding agents.

Two plugins are available in the [`adobe/skills`](https://github.com/adobe/skills "adobe/skills") repository:
...
Install skills with the [`npx skills`](https://www.npmjs.com/package/skills "npx skills") command, run from your project directory. You only need the skills for the capabilities you plan to use — for example, an app that only needs events and webhooks only requires `commerce-app-init`, `commerce-app-eventing`, and `commerce-app-webhooks`.
...
Install the skill with the [`npx skills`](https://www.npmjs.com/package/skills "npx skills") command, run from your project directory.
...
[AI developer tools for Commerce extensibility](https://developer.adobe.com/commerce/extensibility/developer-agent/ "AI developer tools for Commerce extensibility") describes additional AI resources.