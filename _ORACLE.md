...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 19:12 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/60 = 0%   [60 real sessions, 71 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 60   | INFRA 71 (harness, excluded)
- **Queue:** 7 pending
