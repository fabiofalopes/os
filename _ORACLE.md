...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 03:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/8 = 0%   [8 real sessions, 6 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 8   | INFRA 6 (harness, excluded)
- **Queue:** 7 pending
