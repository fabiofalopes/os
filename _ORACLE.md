...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 13:42 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/40 = 0%   [40 real sessions, 39 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 40   | INFRA 39 (harness, excluded)
- **Queue:** 7 pending
