...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 12:57 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/42 = 0%   [42 real sessions, 44 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 42   | INFRA 44 (harness, excluded)
- **Queue:** 7 pending
