...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-06 21:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/19 = 0%   [19 real sessions, 18 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 19   | INFRA 18 (harness, excluded)
- **Queue:** 7 pending
