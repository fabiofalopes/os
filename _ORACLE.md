...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 21:42 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/70 = 0%   [70 real sessions, 64 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 70   | INFRA 64 (harness, excluded)
- **Queue:** 7 pending
