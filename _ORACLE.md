...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-09 14:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/22 = 0%   [22 real sessions, 21 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 22   | INFRA 21 (harness, excluded)
- **Queue:** 7 pending
