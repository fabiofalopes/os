...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 20:27 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/64 = 0%   [64 real sessions, 60 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 64   | INFRA 60 (harness, excluded)
- **Queue:** 7 pending
