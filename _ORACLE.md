...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 03:57 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/12 = 0%   [12 real sessions, 14 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 12   | INFRA 14 (harness, excluded)
- **Queue:** 7 pending
