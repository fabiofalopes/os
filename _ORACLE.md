...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-11 07:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/20 = 0%   [20 real sessions, 22 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 20   | INFRA 22 (harness, excluded)
- **Queue:** 7 pending
