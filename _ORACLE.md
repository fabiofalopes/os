...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-06 19:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/14 = 0%   [14 real sessions, 13 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 14   | INFRA 13 (harness, excluded)
- **Queue:** 7 pending
