...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 20:57 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/67 = 0%   [67 real sessions, 62 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 67   | INFRA 62 (harness, excluded)
- **Queue:** 7 pending
