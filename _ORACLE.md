...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-13 03:57 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/20 = 0%   [20 real sessions, 6 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 20   | INFRA 6 (harness, excluded)
- **Queue:** 4 pending · 3 quarantined ⚠
