...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 09:57 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/32 = 0%   [32 real sessions, 34 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 32   | INFRA 34 (harness, excluded)
- **Queue:** 7 pending
