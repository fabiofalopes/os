...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 21:27 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/65 = 0%   [65 real sessions, 76 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 65   | INFRA 76 (harness, excluded)
- **Queue:** 7 pending
