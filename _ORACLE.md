...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 09:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/31 = 0%   [31 real sessions, 26 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 31   | INFRA 26 (harness, excluded)
- **Queue:** 7 pending
