...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-09 20:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/36 = 0%   [36 real sessions, 42 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 36   | INFRA 42 (harness, excluded)
- **Queue:** 7 pending
