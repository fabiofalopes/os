...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-10 10:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/28 = 0%   [28 real sessions, 42 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 28   | INFRA 42 (harness, excluded)
- **Queue:** 7 pending
