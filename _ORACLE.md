...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-06 17:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/7 = 0%   [7 real sessions, 5 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 7   | INFRA 5 (harness, excluded)
- **Queue:** 7 pending
