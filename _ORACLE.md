...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-10 11:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/30 = 0%   [30 real sessions, 45 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 30   | INFRA 45 (harness, excluded)
- **Queue:** 7 pending
