...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 08:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/21 = 0%   [21 real sessions, 23 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 21   | INFRA 23 (harness, excluded)
- **Queue:** 7 pending
