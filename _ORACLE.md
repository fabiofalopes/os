...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 18:12 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/56 = 0%   [56 real sessions, 65 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 56   | INFRA 65 (harness, excluded)
- **Queue:** 7 pending
