...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-10 23:42 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/50 = 0%   [50 real sessions, 63 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 50   | INFRA 63 (harness, excluded)
- **Queue:** 7 pending
