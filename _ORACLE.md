...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 04:42 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/10 = 0%   [10 real sessions, 9 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 10   | INFRA 9 (harness, excluded)
- **Queue:** 7 pending
