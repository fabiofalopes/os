...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 02:27 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/10 = 0%   [10 real sessions, 10 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 10   | INFRA 10 (harness, excluded)
- **Queue:** 7 pending
