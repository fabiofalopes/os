...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 18:42 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/58 = 0%   [58 real sessions, 68 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 58   | INFRA 68 (harness, excluded)
- **Queue:** 7 pending
