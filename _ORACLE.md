...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-10 23:57 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/53 = 0%   [53 real sessions, 65 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 53   | INFRA 65 (harness, excluded)
- **Queue:** 7 pending
