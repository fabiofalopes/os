...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 14:27 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/46 = 0%   [46 real sessions, 50 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 46   | INFRA 50 (harness, excluded)
- **Queue:** 7 pending
