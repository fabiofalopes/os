...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 20:27 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/62 = 0%   [62 real sessions, 74 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 62   | INFRA 74 (harness, excluded)
- **Queue:** 7 pending
