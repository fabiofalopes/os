...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-09 15:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/24 = 0%   [24 real sessions, 24 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 24   | INFRA 24 (harness, excluded)
- **Queue:** 7 pending
