...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 17:27 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/54 = 0%   [54 real sessions, 62 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 54   | INFRA 62 (harness, excluded)
- **Queue:** 7 pending
