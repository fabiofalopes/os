...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-09 13:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/18 = 0%   [18 real sessions, 15 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 18   | INFRA 15 (harness, excluded)
- **Queue:** 7 pending
