...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-10 05:57 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/16 = 0%   [16 real sessions, 24 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 16   | INFRA 24 (harness, excluded)
- **Queue:** 7 pending
