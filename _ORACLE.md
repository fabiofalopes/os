...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 01:12 UTC by the engine.*
...
## 🟢 Pulse — HEALTHY
- **Today:** Success rate (did its job): 0/2 = 0%   [2 real sessions, 0 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 2   | INFRA 0 (harness, excluded)
- **Queue:** 7 pending
