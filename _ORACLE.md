...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-11 05:57 UTC by the engine.*
...
**⚠ Gateway flap:** 2 holds in 6h — upstream egress degraded, engine auto-holding (FM-7 surface, self-heals). GATEWAY_HOLD lines in LOG.md.

## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/16 = 0%   [16 real sessions, 16 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 16   | INFRA 16 (harness, excluded)
- **Queue:** 7 pending
...
2026-09-07  65    0        0      65    76     0
2026-09-08  52    0        0      52    42     0
2026-09-09  46    0        0      46    57     0
2026-09-10  53    0        0      53    65     0
2026-09-11  16    0        0      16    16     0
```
