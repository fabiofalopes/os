...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 14:42 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/48 = 0%   [48 real sessions, 53 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 48   | INFRA 53 (harness, excluded)
- **Queue:** 7 pending
