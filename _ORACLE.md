...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-08 02:57 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/6 = 0%   [6 real sessions, 3 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 6   | INFRA 3 (harness, excluded)
- **Queue:** 7 pending
