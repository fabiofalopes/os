...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-07 16:12 UTC by the engine.*
...
## 🟦 Pulse — CAPPED
- **Today:** Success rate (did its job): 0/52 = 0%   [52 real sessions, 59 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 52   | INFRA 59 (harness, excluded)
- **Queue:** 7 pending
