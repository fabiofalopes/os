...
> One glance at the Forge — curated, not complete. The richness lives behind the links; this is the lens. *Refreshed 2026-09-12 13:12 UTC by the engine.*
...
## 🔴 Pulse — FAILING
- **Today:** Success rate (did its job): 0/43 = 0%   [43 real sessions, 39 infra fails apart]
- SUCCESS 0   EMPTY 0   FAIL 43   | INFRA 39 (harness, excluded)
- **Queue:** 7 pending
