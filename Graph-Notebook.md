...
*Global Graph = truth · `Map.canvas` = story · Cell 0 = live physics · these four = the microscopes.* **LLM/quota audit of all four:** [[graph-stack-llm-surfaces]]. **The plugin mission tracker (open items):** [[obsidian-plugin-mission]].
